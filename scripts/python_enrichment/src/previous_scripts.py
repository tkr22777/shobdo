...
def process_references():
    ...
    progress = ProgressTracker("data/completed_references.json")
    # progress.print_progress()
    # progress.print_entry_count()

    # Read back and verify
    initially_processed_file = "data/initially_processed_file.json"
    entires_requiring_enrichment = "data/entires_requiring_enrichment.json" 
